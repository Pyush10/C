...
int i;
gotoxy(20,3);
printf("\xB2\xB2\xB2\xB2\xB2\xB2 WELCOME TO LIBRARY MANAGEMENT SYSTEM \xB2\xB2\xB2\xB2\xB2\xB2");
gotoxy(20,5);
...
gotoxy(16,5);
printf("\tC-Programming Project Work");
gotoxy(16,7);
...
{
gotoxy(10,23);
printf("\aPlease enter valid option.");
if(getch())
mainmenu();
}
